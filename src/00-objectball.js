...
function bigShoeRebounds () {
    ...
    for (const team in game) {
        for (const player in game[team].players) {
            if (game[team].players[player].shoe > max) {
                max = game[team].players[player].shoe
                player = player
            }
        }
    }
...
function doesLongNameStealATon() {
    ...
    for (const team in game) {
        for (const player in game[team].players) {
            if (game[team].players[player].name.length > max) {
                max = game[team].players[player].name.length
                player = player
            }
        }
    }
